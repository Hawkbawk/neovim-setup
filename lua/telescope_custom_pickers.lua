-- Shamelessly borrowed from https://github.com/JoosepAlviste/dotfiles/blob/master/config/nvim/lua/j/plugins/telescope_custom_pickers.lua, all so I can filter live_grep by
-- folder or filetype.
